...
export const DeletedColor = {
  /** HAPPY99. */
  HAPPY_YELLOW: Color(1, 0.8, 0),
  HAPPY_YELLOW_DARKER: Color(0.8, 0.6, 0),
  HAPPY_YELLOW_DARKEST: Color(0.6, 0.4, 0),

  /** ILOVEYOU. */
  LOVE_PINK: Color(1, 0.48, 0.7),
  LOVE_PINK_DARKER: Color(0.8, 0.38, 0.6),
  LOVE_PINK_DARKEST: Color(0.6, 0.28, 0.5),

  /** MORRIS. */
  WORM_TURQUOISE: Color(0, 0.96, 0.7),
  WORM_TURQUOISE_DARKER: Color(0, 0.76, 0.5),
  WORM_TURQUOISE_DARKEST: Color(0, 0.56, 0.3),
