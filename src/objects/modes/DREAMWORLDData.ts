...
/** Information about DREAMWORLD. */
// eslint-disable-next-line isaacscript/require-capital-const-assertions
export const DREAMWORLDData: ModeData = {
  description: "This is DREAMWORLD's description",
  birthright: "This is DREAMWORLD's birthright description",
